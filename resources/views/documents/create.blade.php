    ...
    @if ($errors->any())
        ...
        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data" class="p-6" id="document-form">
            ...
            <div class="mt-4 flex" style="justify-content: space-between">
                <a href="{{ route('documents.index') }}" class="inline-block bg-blue-500 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600 transition duration-300">Quay lại</a>
