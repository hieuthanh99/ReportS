    ...
    <div class="container mx-auto px-4 py-6 bg-white p-6 rounded-lg shadow-lg" style="margin-top: 10px;">
        ...
        <form method="GET" action="{{ route('documents.report.target') }}" id="filterForm">
            ...
            <div class="flex justify-end gap-4">
                <a class="fa fa-filter" style="margin-top: 13px;cursor: pointer;" onclick="window.location.href='{{ route('documents.report.target') }}'"></a>
                <button type="submit"
                      ...
                      @if($document->taskTarget)
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="py-3 border border-gray-300 px-6">
                                {{ $document->document->issuingDepartment->name ?? '' }}</td>
                            <td class="py-3 border border-gray-300 px-6">{{ $document->taskTarget->getEndDate() ?? '' }}
                            </td>
