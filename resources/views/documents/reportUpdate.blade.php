                                ...
                                <table class="min-w-full divide-y divide-gray-200 border border-gray-300 table-container">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th colspan="2"
                                                class="col-600 text-center px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        ...
                                        @forelse ($weekTask as $task)
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <span id="uploadStatus-{{ $task->id }}" class="hidden text-green-500">
