...
<div class="container mx-auto px-4 py-6 bg-white p-6 rounded-lg shadow-lg" style="margin-top: 10px;">
    ...
    @endif
        <form action="{{ route('indicator_groups.store') }}" method="POST" enctype="multipart/form-data" class=" p-6" onsubmit="confirmBeforeCreate({ event })">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="code" name="code" class="form-input w-full border border-gray-300 rounded-lg p-2" value="{{ old('code') }}" required oninvalid="this.setCustomValidity('Vui lòng nhập mã loại chỉ tiêu')" 
                ...
                <div class="mb-4">
                    ...
                    <textarea id="name" name="name" class="form-input w-full border border-gray-300 rounded-lg p-2 resize-none" rows="4" required oninvalid="this.setCustomValidity('Vui lòng nhập tên loại chỉ tiêu')" 
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" class="form-input w-full border border-gray-300 rounded-lg p-2 resize-none" rows="4" required oninvalid="this.setCustomValidity('Vui lòng nhập chi tiết loại chỉ tiêu')" 
