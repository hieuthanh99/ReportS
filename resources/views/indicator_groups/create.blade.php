...
@section('content')
    ...
    @endif
        <form action="{{ route('indicator_groups.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg" id="document-form">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Cột trái -->
                <div class="mb-4">
                    <label for="code" class="block text-gray-700 text-sm font-medium mb-2">Mã chỉ tiêu <span class="text-red-500">*</span></label>
                ...
                <div class="mb-4"></div>
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 text-sm font-medium mb-2">Tên chỉ tiêu <span class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                    <label for="description" class="block text-gray-700 text-sm font-medium mb-2">Chi tiết chỉ tiêu<span class="text-red-500">*</span></label>
            ...
            <div class="mt-4 flex" style="justify-content: space-between">
                <a href="{{route('indicator_groups.index')}}" class="bg-gray-600 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-gray-700 transition duration-300 mr-2">Quay lại</a>
