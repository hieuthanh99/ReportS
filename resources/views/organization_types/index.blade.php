            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                <thead class="bg-gray-100 border-b border-gray-300" style="background: #D4D4CF;">
                    <tr>
                        ...
                        <th style="width: 450px;" class="py-3 px-6 text-left text-gray-700 font-medium text-center">Mã phân loại cơ quan</th>
                        <th style="width: 450px;" class="py-3 px-6 text-left text-gray-700 font-medium text-center">Loại cơ quản</th>
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="py-3 border border-gray-300 px-6 text-center">
                                <button class="bg-yellow-300 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition duration-300 ml-2"
                                    onclick="window.location.href='{{ route('organization_types.edit', $item) }}'">
                                    <i class="fas fa-edit"></i> 
                                </button>
                            </td>
                            <td class="py-3 border border-gray-300 px-6 text-center">
                                <form action="{{ route('organization_types.destroy', $item) }}" method="POST" style="display:inline;" onsubmit="confirmBeforeDelete({ event })">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
