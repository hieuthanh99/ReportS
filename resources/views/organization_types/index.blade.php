...
@section('content')
    ...
    <div class="mb-6 flex justify-end gap-4 mb-4">
        <a href="{{ route('organization_types.create') }}" class="inline-block bg-blue-400 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600 transition duration-300"> Thêm mới</i></a>
    </div>
