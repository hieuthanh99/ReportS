...
<div class="container mx-auto px-4 py-6 bg-white p-6 rounded-lg shadow-lg" style="margin-top: 10px;">
    <nav aria-label="breadcrumb">
        ...
        @endif
        <form action="{{ route('task_groups.store') }}" method="POST" enctype="multipart/form-data" class="p-6 " id="document-form" onsubmit="confirmBeforeCreate({ event })">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    oninvalid="this.setCustomValidity('Vui lòng nhập chi tiết nhiệm vụ.')" 
