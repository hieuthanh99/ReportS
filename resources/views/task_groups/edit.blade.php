...
@section('content')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        @endif
        <form action="{{ route('task_groups.update', $taskGroup->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg" onsubmit="confirmBeforeSave({ event })">
