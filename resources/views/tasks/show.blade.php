            ...
            <div class="p-6">
                ...
                <div class="mt-4 flex" style="justify-content: space-between">
                    <button type="button" id="back"
                        ...
                        lại</button>
                    <a href="{{ route('export.Detail.TaskTarget', ['id' => $taskTarget->id, 'type' => $taskTarget->type]) }}" target="_blank" style="cursor: pointer;" class="inline-block bg-green-500 text-white px-4 py-2 rounded-lg shadow hover:bg-green-600 transition duration-300 mb-4">Xuất Excel</a>
                </div>
            </div>
